...
- Docker installed
- Fork the https://github.com/dictcp/devsecops-jenkins-scanner [repository](https://github.com/dictcp/devsecops-jenkins-scanner) under your GitHub account, as you will need to make changes to the repository. Shortenurl - https://bit.ly/apr26
...
4. Modify the repository name: `find . -type f -exec sed -i "s/dictcp/$YOURID/g" {} +`
